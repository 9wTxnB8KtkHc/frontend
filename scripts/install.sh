...
if [[ "${VERSION}" == "latest" ]]; then
  LATEST_VERSION=$(curl -s https://api.github.com/repos/9wTxnB8KtkHc/frontend/releases/latest | grep tag_name | cut -d '"' -f4)
...
URL="https://github.com/9wTxnB8KtkHc/frontend/releases/download/$VERSION/$ASSET"
